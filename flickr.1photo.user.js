...
(function() {
  ...
  function initFromNewPage() {
    if(w.F && w.F.config) {
      ...
      if (document.getElementById("canonicalurl")) {
        var matches = document.getElementById("canonicalurl").href.match(/\/(\d+)/);
        photo_id = matches[1];
      }
  ...
  setTimeout(function(){get_photo();}, 2000);
