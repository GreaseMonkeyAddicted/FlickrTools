...
//  }
  ...
  console.log("photoset_id="+global_photoset_id+", url="+photos_url+", api_key="+api_key+" isOwner="+isOwner);
  ...
  if ( !global_photoset_id || !global_photoset_title || !photos_url || w.document.location.href.indexOf(photos_url)<0 || !_gi('view-holder') ) return;
...
//  var selectedPage = parseInt(prompt("A partir de quelle page ?", ""));
  ...
  if ( _gi("view-holder") )
  {
    ...
    _gi("view-holder").parentNode.insertBefore(cf, _gi("view-holder"));
    _gi("view-holder").parentNode.insertBefore(launcher, _gi("view-holder"));
    _gi("view-holder").parentNode.insertBefore(controller, _gi("view-holder"));
    _gi("view-holder").parentNode.insertBefore(preview, _gi("view-holder"));
